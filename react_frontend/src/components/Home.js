      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            ...
            Currently, I love to work on web application and Mobile Applications
            using technologies like React, NodeJs, BootStrap, Tailwind, Django
            and Firebase.
          </p>
        ...
        <div>
          <img
            src={HeroImage}
            alt="my profile"
            className="rounded-2xl mx-auto w-3/5 md:w-half"
          />
        </div>
      </div>
    </div>
